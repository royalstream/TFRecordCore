...
protoc-3.17.1-osx-x86_64/protoc -I=. --csharp_out=. tensorflow/core/example/feature.proto
protoc-3.17.1-osx-x86_64/protoc -I=. --csharp_out=. tensorflow/core/example/example.proto
